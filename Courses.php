        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 lg:mr-5 ">
            ...
            <div class="bg-blue shadow-lg  rounded-lg p-5 md:p-10 m-3">
                <div class="space-y-2">
                    ...
                    <p class="pb-4">Get interactive, self-paced online classes and tutorials on Deep Learning, Machine Learning, and other topics by using MATLAB Onramp, which offers free MATLAB instruction....</p>
            ...
            <div class="bg-blue shadow-lg  rounded-lg p-5 md:p-10 m-3">
                <div class="space-y-2">
                    ...
                    <p class="pb-4">When computer system resources, particularly data storage (cloud storage) and processing power, are made available on demand without direct active involvement, this is known as cloud computing...</p>
                    <a href="" class="p-3 bg-gray-300 text-black rounded-lg">View course</a>
                </div>
            </div>
            <div class="bg-blue shadow-lg  rounded-lg p-5 md:p-10 m-3">
                <div class="space-y-2">
                    ...
                    <p class="pb-4">Projecting visual communications meant to convey particular ideas is the practice of graphic design, a profession, academic discipline, and applied art...</p>
            ...
            <div class="bg-blue shadow-lg  rounded-lg p-5 md:p-10 m-3">
                <div class="space-y-2">
                    ...
                    <p class="pb-4">Utilizing websites, apps, mobile devices, social media, search engines, and other digital platforms to advertise and sell goods and services is known as digital marketing...</p>
                    <a href="" class="p-3 bg-gray-300 text-black rounded-lg">View course</a>
                </div>
            </div>
            <div class="bg-blue shadow-lg  rounded-lg p-5 md:p-10 m-3">
                <div class="space-y-2">
                    ...
                    <p class="pb-4">A combination of a computer processor, computer memory, and input/output peripheral devices, an embedded system is a specialized computer system with a...</p>
                    <a href="" class="p-3 bg-gray-300 text-black rounded-lg">View course</a>
                </div>
            </div>
        </div>
